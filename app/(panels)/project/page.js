...
export const metadata = {
    title: "Netflix Clone - Educational Project", // Page title
    description: "This is an educational project created for learning purposes. Netflix is not affiliated with this project in any way. It serves as a comprehensive platform showcasing various features including Home, Login, Sign Up, FAQ, Help Centre, Media Centre, and more.", // Page description for SEO
    keywords: "Netflix clone, educational project, learning, Next.js, MongoDB, user authentication, streaming platform, web app, project overview, dummy pages", // Relevant keywords for SEO
    author: "Soumajit Mandal 2023ETB016", // Author name with identification
};
    ...
    return (
        <div className="relative">
            ...
            <div className="absolute top-0 -z-10 h-full w-full bg-white">
                {/* Large background circles for visual effect */}
            ...
            <div className="flex 3xl:w-[1920px] mx-auto relative">
                <main className="flex-grow px-8 py-12 md:ml-16 xmd:ml-0 xmd:pl-48 overflow-y-auto">
                    <div className="text-black mb space-y-1">
                        ...
                        <p className="text-lg text-gray-600">This is an educational project created for learning purposes.</p>
                        <p className="text-lg text-gray-600">Netflix is not affiliated with this project in any way.</p>
                        <p className="text-lg text-gray-600">By Soumajit Mandal 2023ETB016</p>

                        {/* Informative Div */}
                        <div className="mt-8 p-6">
                            <h2 className="text-2xl font-semibold text-gray-800">Accessible Pages</h2>
                            <p className="mt-2 text-gray-700">The following pages are built and accessible:</p>
                            ...
                            <p className="mt-2 text-gray-700">The following pages are dummy and will redirect here:</p>
                            <ul className="mt-4 list-disc list-inside bg-[#ffffff30] rounded-lg shadow-sm p-12 border-2 border-red-500">
                                {/* List of dummy pages */}
                            ...
                            <p className="mt-4 text-gray-600">
                                Attempting to log in or sign up will redirect you with credentials stored locally or in the database.
                            </p>
                        </div>
                    </div>
                </main>
