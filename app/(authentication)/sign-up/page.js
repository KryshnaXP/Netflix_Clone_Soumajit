      ...
      <main className="h-screen flex justify-center py-40">
        <div className="flex flex-col md:items-center">
          ...
          <div className="space-y-1 mt-12 mb-12">
            <p className="text-gray-800 md:text-center text-xs">STEP <strong>1</strong> OF <strong>4</strong></p>
            <p className="text-gray-800 md:text-center text-3xl font-semibold w-2/3 mx-auto">Finish setting up your account</p>
